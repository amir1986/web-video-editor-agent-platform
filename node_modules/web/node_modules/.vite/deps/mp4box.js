...
var _isTupleType, isTupleType_fn, _a;
var DataStream = (_a = class {
  ...
  constructor(arrayBuffer, byteOffset, endianness) {
    __privateAdd(this, _isTupleType);
    this._byteLength = 0;
  ...
  writeType(type, value, struct) {
    ...
    switch (parsedType) {
      ...
      case "u16stringbe":
        ...
        break;
      default:
        if (__privateMethod(this, _isTupleType, isTupleType_fn).call(this, parsedType)) {
          const [, ta] = parsedType;
...
}, _isTupleType = new WeakSet(), isTupleType_fn = function(type) {
